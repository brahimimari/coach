...
<p>Première partie : L’essentiel de la comptabilité générale et de l’analyse financière pour non Financiers
     ...
     <div class="accordion" id="myAccordion">
            ...
            <div id="collapsefoor" class="accordion-collapse collapse">
                <div class="card-body">
								<ul class="step_point">
									...
									<li>	Le budget de trésorerie - Cas pratique sur ordinateur</li>
                                 </ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#">4.Contrôle budgétaire</button>                     
            </h2>
