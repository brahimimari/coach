            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>S.201 _ Comptabilite Analytique</h1>
     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne"> I- Nature, objet et origine de la comptabilité analytique</button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li> Définition de la comptabilité analytique</li>
						<li>La comptabilité analytique complément de la comptabilité générale</li>
					</ul> 
				</div>
			</div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">II- Passage de la comptabilité générale à la comptabilité analytique</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
                                    <li>Articulation avec la comptabilité générale</li>
					</ul>
					</p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">III- Méthode de coût complet </button>                     
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
                                    <li>Méthode des centres d'analyse</li>
                                    <li>Application - Cas CHIMINTER</li>
                                 </ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">IV- Méthode de coût ratoinnel</button>                     
            </h2>
        </div>
    </div>
...
<div class="cadreformation">
								...
								<ul class="step_point">
									...
									<li>Comprendre l'univers Banque à Entreprise</li>
