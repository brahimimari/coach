...
.accordion-button:not(.collapsed) {
    ...
    background-color: #213f651a !important;
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                <div class="courses_details">
					...
					<h3>A qui s'adresse cette formation ? </h3>
						 ...
						 <div style="padding: 36px;background-color: #213f65;
    border-radius: 10px;width:100% !important;color: #fff !important;margin: 6% 0 0 0%;" class="">
								<div>
									<h3 style="color: #fff !important;">Pour qui</h3>
					 <p style="font-size:14px !important;color: #fff !important;"> Tout cadre et dirigeant sans formation financière approfondie, comme les directeurs généraux, Directeurs financiers, Responsables financiers, Comptables, Contrôleurs de gestion
