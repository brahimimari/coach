            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                <div class="courses_details">
					...
					<h3 class="h3formation">A qui s'adresse cette formation ? </h3>
					 ...
					 <p class="textecadre"> Tout cadre et dirigeant sans formation financière approfondie, comme les directeurs généraux, Directeurs financiers, Directeurs commerciaux, Responsables financiers, Contrôleurs de gestion et Responsables de fonctions
 et</p>
     ...
     <div class="accordion" id="myAccordion">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">II. Impact de l'environnement sur l'entreprise</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
						<li>Démystification de la stratégie</li>
						<li>Psychologie du Dirigeant</li>
						<li>Schéma des forces de Porter</li>
						<li>Analyse externe (Univers des influences, Univers de l’offre et Univers de la demande)</li>
						<li>Analyse interne : Etat des lieux</li>
						<li>Analyse de la chaine de valeur</li>
						<li>Analyser SWOT</li>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">III. Analyse stratégique de l'entreprise </button>                     
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
                                    <li>Segmentation stratégique</li>
                                    <li>Carte stratégiques actuelle</li>
                                    <li>Rééquilibrage & Carte stratégique future</li>
                                    <li>Dispositif complémentaire à la segmentation</li>
                                 </ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">IV. Déploiement stratégique par fonction</button>                     
            </h2>
            <div id="collapsefoor" class="accordion-collapse collapse">
                <div class="card-body">
								<ul class="step_point">
                                    <li>Déploiement stratégique</li>
                                    <li>Suivi stratégique (Balanced Score Card)</li>
	...
	<h3 class="h3formation">Les objectifs de la formation</h3>
							...
							<div class="cadreformation">
								<div>
								<ul class="step_point">
                                    <li> Connaître et utiliser les principaux outils et méthodes d'analyse stratégique pour construire sa stratégie orientée clients</li>
									<li>  Enrichir et renouveler sa réflexion en intégrant les apports les plus récents de l'analyse stratégique</li>
									<li>  Évaluer ses propres pratiques managériales pour assurer le déploiement stratégique</li>
								 </ul>  
