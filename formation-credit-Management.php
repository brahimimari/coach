...
<head>
    ...
    <title>Formation Credit management</title>
     <!-- Goole Font -->
            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>Domaine : Credit management</h1>
        ...
        <div class="row">
		   ...
		   <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                     <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="formation-recouvrement-casablanca.php">Récupérez votre C.A. en souffrance</a></h3>
                          <!--  <div class="teachers_name">Formateur - <a href="#" title="">Nacir Mohammed</a></div> -->
                        </div>
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="formation-recouvrement-casablanca.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
