...
<section class="popular_courses" id="popular_courses_page">
                ...
                <div class="single-courses">
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="finance-pour-dirigeants-non-financiers.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
                ...
                <div class="single-courses">
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="Negociation-Bancaire-Et-Gestion-De-Tresorerie.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
 ...
 <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                     <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="Approche-Pratique-Du-Diagnostic-Financier.php">Approche pratique du Diagnostic financier
</a></h3>
                          <!--  <div class="teachers_name">Formateur - <a href="#" title="">Nacir Mohammed</a></div> -->
                        </div>
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="Approche-Pratique-Du-Diagnostic-Financier.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
                </div> 
		...
		<div class="col-12 col-sm-6 col-md-6 col-lg-4">
				...
				<div class="single-courses">
                     <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="cartographie-des-risques-financiers.php">Cartographie des risques financiers</a></h3>
                          <!--  <div class="teachers_name">Formateur - <a href="#" title="">Nacir Mohammed</a></div> -->
                        </div>
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="cartographie-des-risques-financiers.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
