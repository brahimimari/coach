            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                <div class="courses_details">
					...
					<h3 class="h3formation">A qui s'adresse cette formation ? </h3>
					 ...
					 <p class="textecadre"> Cette formation est destinée à tous les cadres et dirigeants en gestion des ressources humaines, tels que les Directeurs généraux, Directeurs des Ressources Humaines, Responsables des Ressources Humaines, Responsables Ingénierie de formation, Directeurs et Responsables de fonction.
             ...
             <div id="collapseTwo" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
                                    ...
                                    <li>Le déroulement : besoins des participants et rôle du formateur</li>
                                    <li>La conclusion</li>
                                 </ul>
                </div>
            </div>
...
<div class="cadreformation">
								...
								<li>  	Asseoir la pierre angulaire de votre réorganisation d’entreprise</li>
