     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne">1. Introduction à la cession interne </button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li>Qu’est-ce que le PCI ?</li>
						<li>L’intérêt de la méthode</li>
						<li>Les utilisateurs possibles du PCI</li>
					</ul> 
				</div>
			</div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">2. Les pré – requis de la méthode PCI</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
                                    <li>Centre de responsabilité</li>
                                    <li>Création des intraprises</li>
                                    <li>Facturation interne</li>
                                    <li>Comptabilité intraprise</li>
                                    <li>CPC intraprise</li>
					</ul>
					</p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3. La Création de valeur </button>                     
            </h2>
...
<div class="cadreformation">
								<div>
								<ul class="step_point">
									 <li>Assimiler l’intérêt de la méthode et son impact sur la performance d’entreprise</li>
									 <li>Instaurer une culture de fournisseur interne et client interne</li>
									 <li>Développer une comptabilité managériale par Intraprise</li>
									 <li>Instaurer la culture de rentabilité et de compétitivité par fonction</li>
									 <li>Définir les fonctions génératrices et destructrices de la valeur</li>
									 <li>Prendre des décisions de développement ou d’externalisation</li>
								 </ul>  
