            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>F.702 _ Du stress à l'énergie positive</h1>
     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne">    1. Évaluer ses modes de fonctionnement face au stress</button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li>Connaitre ses signaux d'alerte</li>
						<li>Connaître ses agents stresseurs</li>
						<li>Diagnostiquer ses niveaux de stress (Test N°1 : Niveaux de stress par Nature)</li>
						<li>Tests d’auto – évaluation (Test N°2 : Etes-vous en manque de stress)
							<br />(Test N°3 : Votre comportement vous protège-t-il contre le stress ?)
						</li>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo"> 2. Stratégies de lutte anti – stress</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
                                    <li>Les 23 stratégies de lutte anti – stress</li>
                                    <li>La spiritualité comme stratégie de lutte anti - stress</li>
                                    <li>Le système de la balance</li>
 					</ul>
					</p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3. L’intelligence émotionnelle face au stress </button>                     
            </h2>
             <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
								<ul class="step_point">
                                    <li>Qu’est ce que l’émotion ?</li>
                                    <li>Développer son intelligence émotionnelle (Test N°4 : Degré d'intelligence émotionnelle)</li>
                                    <li>Le système de la balance</li>
                                 </ul>
                </div>
            </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4. Renforcer la confiance en soi</button>                     
            </h2>
            <div id="collapsefoor" class="accordion-collapse collapse">
                <div class="card-body">
								<ul class="step_point">
                                    <li>Qu’est ce que la Confiance en soi</li>
                                    <li>Un autodiagnostic - Confiance en moi (Test N°5 : Confiance en soi)</li>
                                    <li>Les 10 étapes de développement de confiance en soi</li>
                                  </ul>
                </div>
            </div>
        </div>
...
<div class="cadreformation">
								...
								<ul class="step_point">
									...
									<li>	Comprendre le fonctionnement du stress</li>
									<li>	Être habilité à définir ses agents stresseurs et les traiter avec efficacité</li>
									<li>	S’approprier les stratégies gagnantes de lutte anti – stress</li>
									<li>	Mieux se servir de son intelligence émotionnelle</li>
