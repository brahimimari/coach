            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>S.202 _ Introduction au Controle de gestion</h1>                        
                    </div>
                </div>              
     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne"> 1. Introduction au Contrôle de gestion </button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li>Démistification du contrôle de gestion</li>
						<li>Objectifs du contrôle de gestion</li>
						<li> Acteurs & Clients du Contrôle de gestion</li>
						<li>Organisation de la fonction Contrôle de gestion</li>
					</ul> 
				</div>
			</div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">2. Processus de contrôle de gestion</button>
            </h2>
            
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3. Outils de contrôle de gestion </button>                     
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
                                    <li>Le contrôle de gestion stratégique / Balanced Score Card : (Tableau de bord prospectif)</li>
								   <li>Le calcul de coûts & Analyse des marges</li>
								   <li>Les budgets & Contrôle budgétaire</li>
								   <li>Les tableaux de bord</li>
								   <li>Le reporting</li>
								   <li>Les missions de Cost Killing</li>
                                 </ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4. Création de la valeur</button>                     
            </h2>
        </div>
		
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">5. Maîtrise de la performance Balance Score Card</button>                     
            </h2>
        </div>
...
<div class="cadreformation">
								<div>
								<ul class="step_point">
									<li>  Comprendre la philosophie du contrôle de gestion et ses objectifs</li>
									<li> Appréhender le processus de contrôle de gestion</li>
									<li> Cerner les outils du contrôle de gestion</li>
									<li> Comprendre l’esprit du la création de valeur et son impact sur la rentabilité de l’entreprise</li>
									<li> Découvrir le balanced score card</li>
								 </ul>  
