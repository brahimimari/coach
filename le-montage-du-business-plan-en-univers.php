            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>F.108 _ Le montage du Business Plan en univers</h1>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse">
                    ...
                    <ul class="step_point">
						...
						<li>Les critères de choix d&#39;investissement dans l&#39;Univers incertain (Effet de
levier, rentabilité financière prévisionnelle, VAN, TRI, Indice de profitabilité &amp; Pay - Back)</li>
					</ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button-no collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4.Cas pratique sur Template – Entreprise industrielle</button>                     
            </h2>
