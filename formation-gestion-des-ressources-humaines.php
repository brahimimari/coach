        ...
        <div class="row">
                ...
                <div class="single-courses">
                     <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="reussissez-votre-ingenierie-de-formation-en-interne.php">Réussissez votre Ingénierie de formation en Interne</a></h3>
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="reussissez-votre-ingenierie-de-formation-en-interne.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
		   ...
		   <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                     <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="formation-des-formateurs.php">Formation des formateurs</a></h3>
                          <!--  <div class="teachers_name">Formateur - <a href="#" title="">Nacir Mohammed</a></div> -->
                        </div>
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="formation-des-formateurs.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
                ...
                <div class="single-courses">
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
						 ...
						 <a href="Elaboration-de-la-fiche-Poste-Profil.php" class="cart_btn">Voir la formation</a>
                         </div>
                    </div>
                </div> 
