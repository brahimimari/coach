            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>F.803 _ Cross Selling & Up Selling</h1>
     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne">Partie 1 : Cross Selling ?</button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li>Avantages de l’approche</li>
						<li>Méthodes et application du Cross Selling
							<br />
							<br />
							<ul class="step_point">
								<li>Bien connaitre les attentes de votre client _ QQOQCP</li>
								<li>Formulez votre offre de Cross Selling au moment opportun</li>
								<li>Largeur & Profondeur de la gamme</li>
								<li>Choisissez la méthode de Cross Selling adaptée</li>
								<li>Faire évoluer son Cross Selling</li>
							</ul>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo"> Partie 2 : Up Selling ?</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
					...
					<ul class="step_point">
                                    <li>Avantages de l’approche</li>
                                    <li>Méthodes et application de l’Up Selling</li>
                                    <li>Les formes de l’Up Selling les plus courantes</li>
					</ul>
					</p>
                </div>
            </div>
