     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li>Diagnostic financier : Définition & Objectifs</li>
						<li>Donneurs d’ordres</li>
						<li>Objectifs du diagnostic financier</li>
						<li>Qualités de l’analyste financier</li>
					</ul> 
				</div>
			</div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">2.Examen global de la situation</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
                                    <li>Intérêt de l’examen global de la situation</li>
                                    <li>Nature de l’examen global de la situation</li>
					</ul>
					</p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3.Recherche des informations additionnelles</button>                     
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
						<li>Objectif de la recherche des informations</li>
						<li>Sources des informations additionnelles</li>
					</ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4.Techniques de l’analyse financière</button>                     
            </h2>
            <div id="collapsefoor" class="accordion-collapse collapse">
                <div class="card-body">
								<ul class="step_point">
                                    <li>Création de la valeur</li>
                                    <li>Analyse financière fondée sur le bilan</li>
                                    <li>Analyse par les ratios</li>
                                    <li>Analyse des performances financières de l’entreprise</li>
                                    <li>Analyse discriminante</li>
                                    <li>Analyse boursière</li>
                                 </ul>
                </div>
            </div>
        </div>
