            ...
            <ul>
                <li data-index="rs-1706" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption font-lora sfb tp-resizeme letter-space-5 h-p" 
                        ...
                        style="z-index: 7; color:#fff; font-family:'Rubik', sans-serif; max-width: auto; max-height: auto; white-space: nowrap; font-weight:500;">Boostez vos compétences avec les formations incontournables de Coach Consulting !
                    ...
                    <div class="tp-caption NotGeneric-Title   tp-resizeme" 
                        ...
                        style="z-index: 5; font-family:'Roboto', sans-serif; font-weight: 900; white-space: nowrap;text-transform:left;">Découvrez l'excellence en formation 
                    </div>
                    ...
                    <div class="tp-caption NotGeneric-Title   tp-resizeme" 
                        ...
                        style="z-index: 5; font-family:'Roboto', sans-serif; font-weight: 900; white-space: nowrap;text-transform:left;">avec nous.
                    </div>
                    ...
                    <div class="tp-caption rev-btn rev-btn left_btn" 
                        ...
                        style="z-index: 14; white-space: nowrap; font-weight: 500; color: #ffffff;font-family:Rubik; text-transform:uppercase; background-color:#ff5a2c; border-color:rgba(0, 0, 0, 1.00); border-width:2px;  border-radius: 3px;">Nos formations
                    </div>
    ...
    <div class="container"> 
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="sub	_title">
                    <h2>Nos formations les plus demandées</h2>
                    <p>Pour répondre à vos attentes, Coach Consulting vous propose des séminaires programmés incluant les formations les plus populaires.</p>  
                    ...
                    <div class="courses_info_wrapper">
                        ...
                        <div class="courses_info">
                            <ul class="list-unstyled">
								...
								<li><div class="teachers_name">Animateur - <a href="#" title="">M. Mohammed NACIR</a></div></li>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    ...
                    <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="#">New H.R. Dashboard<br />&nbsp;<br /></a></h3>
                         </div>
                        <div class="courses_info">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-calendar-alt"></i>2 Jours</li>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    ...
                    <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="#">Advanced Budgeting <br />&nbsp;<br /></a></h3>
                         </div>
                      <div class="courses_info">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-calendar-alt"></i>2 Jours</li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="sub_title">
                    <h2>Blog</h2>
                    <p>Bienvenue sur notre dernier blog ! Nous sommes ravis de vous présenter les dernières actualités, tendances et idées dans le domaine de la formation en entreprise.
					</p>  
                </div><!-- ends: .section-header -->
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                 <div class="single_item single_item_first">
                    ...
                    <div class="blog_title">
                        <span>L'Importance de la Formation Continue en Entreprise</span>  
                        
                        <div class="post_bloger">
                            <span>15/02/2023 - By </span> <span class="bloger_name"></span>
                        </div>               
                    </div>   
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="single_item single_item_center">
                    ...
                    <div class="blog_title">
                        <span>Les Meilleures Pratiques pour Déployer une Formation en Ligne Efficace</span>  
                         <div class="post_bloger">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
               <div class="single_item single_item_last">
                    ...
                    <div class="blog_title">
                        <span>Utiliser la Réalité Virtuelle pour Transformer la Formation en Entreprise</span>  
                         <div class="post_bloger">
