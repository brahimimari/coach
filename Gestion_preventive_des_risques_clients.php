            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>S.601 _ Gestion préventive des risques clients</h1>
     ...
     <div class="accordion" id="myAccordion">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">2. L’évaluation du risque client</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
                                    <li>Connaitre le client</li>
                                    <li>Evaluer le client</li>
                                    <li>Le Scoring</li>
                                    <li>Fonction Score Z</li>
                                    <li>Méthode des points de risque</li>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3. La prévention et la couverture du risque client </button>                     
            </h2>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4. Le recouvrement des créances clients</button>                     
            </h2>
            
        </div>
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">5. Le financement du poste clients</button>                     
            </h2>
            
        </div>
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">6. Le tableau de bord du Credit Manager</button>                     
            </h2>
...
<div class="cadreformation">
								<div>
								<ul class="step_point">
                                    <li>  Savoir identifier les risques clients</li>
									<li>  Réussir sa prise de fonction de Credit Manager</li>
									<li>  Mettre en place une démarche de prévention des risques clients</li>
