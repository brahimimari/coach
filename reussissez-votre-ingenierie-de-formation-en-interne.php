            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                <div class="courses_details">
					...
					<h3 class="h3formation">A qui s'adresse cette formation ? </h3>
					 ...
					 <p class="textecadre"> Cette formation est destinée à tous les cadres et dirigeants, tels que les Directeurs des Ressources Humaines, Responsables des Ressources Humaines, Responsables Ingénierie de formation et Responsables de formation.</p>
     ...
     <div class="accordion" id="myAccordion">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
                                    <li>L'évaluation basée sur les orientations stratégiques, les TB, les rapports d’audit</li>
                                    <li>La Due Diligence - IFO</li>
                                    <li>L'entretien individuel semi - directif</li>
                                    <li>L'entretien collectif</li>
                                    <li>Zoom sur les supports de collecte de besoins normalisés par le SECFP</li>
                                 </ul>
                </div>
            </div>
        </div>
...
<div class="cadreformation">
                               ...
                               <li>   Appréhenser le role de l’Ingénierie de formation dans les développements stratégique et R.H. de l’entreprise</li>
								...
								<li> Maitriser les techniques de collecte des besoins en formation</li>
								<li> Réussir la rédaction de l’ingénierie suivant le modèle arrété par le Ministére de tutelle</li>
								<li> Les diffrenets points à surveiller et pièges à éviter pour grantir la validation de l’ingénierie et du plan successivemet par le GIAC et les CSF</li>
