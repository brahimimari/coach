            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>F.701 _ La Force de vente agressive</h1>
     ...
     <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne">    1.Diagnostiquer la performance de son équipe commerciale</button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show">
                <div class="card-body">
					<ul class="step_point">
						<li>Mettre en exergue les résultats factuels</li>
						<li>Analyser la morpho gestuelle</li>
						<li>Détecter les facteurs clés de succès et les dysfonctionnements</li>
						<li>Cerner les compétences clés associées à la performance</li>
 					</ul> 
				</div>
			</div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo"> 2.Mesurer les écarts par rapport à une performance commerciale optimale</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
                    <p>
					<ul class="step_point">
                                    <li>Choisir ses indicateurs quantitatifs : ratios, tableaux de bord, leviers de performance</li>
                                    <li>Construire ses outils de mesure qualitatifs : la grille de compétences</li>
 					</ul>
					</p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3.Construire la relation de coaching avec son commercial </button>                     
            </h2>
             <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
								<ul class="step_point">
                                    ...
                                    <li>Le rapport mensuel du Directeur de vente</li>
                                 </ul>
                </div>
            </div>
        </div>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4.Le processus Coaching Terrain</button>                     
            </h2>
...
<div class="cadreformation">
								...
								<ul class="step_point">
									...
									<li>Comprendre les principes de base du coaching commercial</li>
									<li>Identifier les progrès individuels et collectifs à obtenir</li>
									<li>Débriefer un entretien commercial</li>
									<li>Sélectionner et mettre en place l'action de coaching la plus efficace</li>
									<li>Engager et donner l'envie de progresser</li>
									<li>Accompagner et entretenir le progrès grâce au coaching commercial</li>
