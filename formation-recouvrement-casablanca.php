            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1>S.602 _ Récupérez votre C.A. en souffrance</h1>
 ...
 <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapseOne"> 1. Description du poste Recouvrement </button>									
            </h2>
           
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo">2. Les moyens de prévention en amont</button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse ">
                <div class="card-body">
					...
					<ul class="step_point">
                                    ...
                                    <li>Les mentions facultatives</li>
 					</ul>
					</p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">3. Le recouvrement des créances clients </button>                     
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse">
                <div class="card-body">
                    <ul class="step_point">
                                    <li>Réglementation des délais de paiement au Maroc</li>
                                    <li>Nature et typologie des débiteurs</li>
                                    <li>La préparation au Recouvrement</li>
                                    <li>Traitement des litiges</li>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">4. Le choix des supports de paiement</button>                     
            </h2>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">5. Le tableau de suivi - Recouvrement _ Modèle de tableau de suivi</button>                     
            </h2>
		...
		<div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefoor">6. Le tableau de bord Recouvrement _ Modèle du TB Recouvrement</button>                     
            </h2>
...
<div class="cadreformation">
								<div>
								<ul class="step_point">
                                    <li>  Construire la fiche de poste du Responsable recouvrement</li>
                                    <li>  Se prémunir contre le retard d'encaissement</li>
                                    <li>  Organiser la relance des retards de paiement</li>
                                    <li>  Mesurer le poids des factures et des clients</li>
                                    <li>  Mener un entretien de relance, négocier</li>
                                    <li>  Créer le tableau de bord de la fonction</li>
								 </ul>  
